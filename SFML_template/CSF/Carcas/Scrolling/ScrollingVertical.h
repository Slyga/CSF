...
namespace csf
{
	class ScrollingVertical :public Scrolling
	{
	protected:
		class ScrollPlateVertical :public ScrollPlate
		{
		public:
			/// <summary>
			/// Конструктор
			...
			ScrollPlateVertical(BaseObject* master, string name);
	...
	public:
		...
		ScrollingVertical(mySprite* master, mySprite* Box, Button* upScrollButton, Button* downScrollButton, string nameScrollPlate);
		/// <summary>
		/// Конструктор
		/// </summary>
		/// <param name="master">Указатель на объект мастера</param>
		/// <param name="name">Имя текстуры</param>
		ScrollingVertical(mySprite* master, string name);
